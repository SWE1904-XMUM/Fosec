            ...
            <div class="form-container">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pillsLogin" runat="server">
                        ...
                        <asp:Button ID="loginBtn" CssClass="btn mb-3" runat="server" Text="Login" OnClick="LoginBtn_Click" />
                     </div>
                     <div class="tab-pane fade show active" id="pillsSignup" runat="server">
                        ...
                        <asp:Button CssClass="btn mb-3" ID="signupBtn" runat="server" Text="Sign Up" OnClick="SignupBtn_Click" />
                        </div>
                    </div>
            </div>
        </div>
